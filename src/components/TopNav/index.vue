<template>
  <el-menu :default-active="activeMenu" mode="horizontal" @select="handleSelect">
    ...
    <!-- 顶部菜单超出数量折叠 -->
    <el-submenu :style="{ backgroundColor: $store.state.user.projectData.themeColor || $store.state.settings.bgcColor }" index="more" v-if="topMenus.length > visibleNumber">
...
// 隐藏侧边栏路由
const hideList = ['/index', '/user/profile', '/data'];
export default {
  data () {
    return {
      // 顶部栏初始数
