                    ...
                    <div class="left-sidebar">
                        ...
                        <el-menu :default-active="activeModel" class="model-menu" background-color="#fff"
                            ...
                            <el-menu-item v-for="model in filteredModels" :key="model.name" :index="model.name"
                                ...
                                <svg-icon
                                    :icon-class="model.label == 'Ollama' ? 'Ollama' : model.label == '阿里云百炼' ? 'alybl' : model.label == 'Deepseek深度求索' ? 'deepseek' : model.label == '灵启系统' ? 'lingqi' : model.label == 'Open AI' ? 'openAi' : 'local'" 
                ...
                <el-card shadow="never" class="right-content-card">
                    <div class="right-content">
                        <div class="content-header">
                            <svg-icon
                                :icon-class="currentModel.label == 'Ollama' ? 'Ollama' : currentModel.label == '阿里云百炼' ? 'alybl' : currentModel.label == 'Deepseek深度求索' ? 'deepseek' : currentModel.label == '灵启系统' ? 'lingqi' : currentModel.label == 'Open AI' ? 'openAi' : 'local'"
                                style="margin-right: 10px;"></svg-icon>
